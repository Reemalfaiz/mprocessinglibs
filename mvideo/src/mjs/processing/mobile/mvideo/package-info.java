...
/**
 * MVideo library allows Mobile Processing to load and play video files from 
 * the data directory or from a server.
 *
 * allows capture video from camera phones and grab snapshots of videos.
 *
 * This Library is based on the class and methods availables under Processing 
 * to allow an easy understading.
 *
