...
void setup()
{
  mRequest = new MRestRequest(this,"http://local.yahooapis.com/LocalSearchService/V3/localSearch");
...
void libraryEvent(Object library, int event, Object data)
{
  if(library == mRequest)
  {
     MRestResponse mResponse = (MRestResponse) data;
     println("num results: " + int(mResponse.get("/ResultSet/@totalResultsReturned")));
     
     MRestResult[] results = mResponse.getResults("/ResultSet/Result");
