 ...
 *
 * $Id: FrequencyModulation.pde 310 2007-11-04 20:09:49Z marlonj $
 */
...
void setup()
{
  // Modulate the frequency using a sine wave
  MGenerator freq = new MSin(2,0,2);
  MGenerator phase = new MConstant(0); 
  MGenerator amp = new MConstant(0.5);  
