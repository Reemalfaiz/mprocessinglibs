 ...
 */
public class MMediaServerP extends MMediaServer
{
	/**
	 * The Applet
	 */
	 ...
	 */
	public MMediaServerP(PApplet pApplet, MBt mBt)
	{
	...
	{
		// Remove initial / to use openStream function 
		fileName = fileName.substring(1);
		
		// Open the file like a resource 
		return pApplet.openStream(fileName);
	}	 	
}